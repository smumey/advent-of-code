...
public class D04WordSearch {
    ...
    private char[] upChars(Coordinate coordinate) {
        char[] chars = {
                puzzle.getCharAt(coordinate.moveMirrored(Direction.DOWN).moveMirrored(Direction.LEFT)),
                puzzle.getCharAt(coordinate.moveMirrored(Direction.UP).moveMirrored(Direction.RIGHT))
        };
        Arrays.sort(chars);
        return chars;
    }
    ...
    private char[] downChars(Coordinate coordinate) {
        char[] chars = {
                puzzle.getCharAt(coordinate.moveMirrored(Direction.UP).moveMirrored(Direction.LEFT)),
                puzzle.getCharAt(coordinate.moveMirrored(Direction.DOWN).moveMirrored(Direction.RIGHT))
        };
        Arrays.sort(chars);
        return chars;
    }
